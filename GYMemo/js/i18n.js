...
const TRANSLATIONS = {
    ko: {
        ...
        comingSoon: '준비 중',
        addTemplate: '템플릿 추가',
        enterTemplateName: '템플릿 이름을 입력하세요',
        addTemplateBtn: '추가하기',
        selectedExercises: '선택된 운동',
        tapToAddExercise: '아래에서 운동을 선택하세요',
        searchTemplate: '템플릿 검색',
        noTemplates: '등록된 템플릿이 없습니다',
        deleteTemplateConfirm: (name) => `"${name}" 템플릿을 삭제하시겠습니까?`,
        ...
        // 메뉴
        language: '언어',
        weightUnitLabel: '무게 단위',
        dataManagement: '데이터 관리',
        loadData: '데이터 불러오기',
        exportData: '데이터 내보내기',
        invalidFileFormat: '올바른 데이터 파일이 아닙니다.',
        confirmLoad: '운동 {exercises}개, 기록 {records}개를 불러옵니다.\n기존 데이터가 덮어씌워집니다. 계속하시겠습니까?',
        loadSuccess: '데이터를 불러왔습니다.',
        loadError: '파일을 읽는 중 오류가 발생했습니다.',
        exportSuccess: '데이터를 내보냈습니다.',
        exportSuccessPath: '파일이 저장되었습니다:\n{path}',
        exportShareText: '헬스로그 백업 파일',
        exportChooseLocation: '저장 위치 선택',
        exportError: '내보내기 중 오류가 발생했습니다.',
        resetData: '데이터 초기화',
        resetDataConfirm: '모든 운동과 기록이 삭제됩니다.\n정말 초기화하시겠습니까?',
    ...
    en: {
        ...
        tapToAddExercise: 'Select exercises below',
        searchTemplate: 'Search templates',
        noTemplates: 'No templates yet',
        deleteTemplateConfirm: (name) => `Delete "${name}" template?`,

        // MY / Profile
        myProfile: 'Profile',
        appSettings: 'App Settings',
        profileGoal: 'Goal',
        goalDiet: 'Weight Loss',
        ...
        invalidFileFormat: 'Invalid data file.',
        confirmLoad: 'Load {exercises} exercises and {records} records?\nExisting data will be overwritten.',
        ...
        resetDataConfirm: 'All exercises and records will be deleted.\nAre you sure?',
        resetDataSuccess: 'Data has been reset.',
        confirm: 'OK',
        exit: 'Exit',
